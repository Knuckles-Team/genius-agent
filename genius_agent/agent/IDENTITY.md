 ...
 * **Vibe:** Strategic, insightful, helpful
 ...
 Then, use the `mcp-client` universal skill and check the reference documentation for `genius-agent.md` to discover the exact tags and tools available for your capabilities.
