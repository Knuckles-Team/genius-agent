...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [OPTIONS](https://git-scm.com/docs/git-instaweb#_options)
    * [CONFIGURATION](https://git-scm.com/docs/git-instaweb#_configuration)
    * [SEE ALSO](https://git-scm.com/docs/git-instaweb#_see_also)
    * [GIT](https://git-scm.com/docs/git-instaweb#_git)


[ English ▾](https://git-scm.com/docs/git-instaweb)
Localized versions of **git-instaweb** manual
  1. [English ](https://git-scm.com/docs/git-instaweb)
  2. [Français ](https://git-scm.com/docs/git-instaweb/fr)
  3. [Português (Brasil) ](https://git-scm.com/docs/git-instaweb/pt_BR)
...
`git --version`
##  [](https://git-scm.com/docs/git-instaweb#_name)NAME
git-instaweb - Instantly browse your working repository in gitweb
##  [](https://git-scm.com/docs/git-instaweb#_synopsis)SYNOPSIS
```
...
If the configuration variable `instaweb.browser` is not set, `web.browser` will be used instead if it is defined. See [git-web--browse[1]](https://git-scm.com/docs/git-web--browse) for more information about this.
##  [](https://git-scm.com/docs/git-instaweb#_see_also)SEE ALSO
