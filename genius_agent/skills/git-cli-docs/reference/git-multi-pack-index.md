...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [OPTIONS](https://git-scm.com/docs/git-multi-pack-index#_options)
    * [EXAMPLES](https://git-scm.com/docs/git-multi-pack-index#_examples)
    * [SEE ALSO](https://git-scm.com/docs/git-multi-pack-index#_see_also)
    * [GIT](https://git-scm.com/docs/git-multi-pack-index#_git)


[ English ▾](https://git-scm.com/docs/git-multi-pack-index)
...
##  [](https://git-scm.com/docs/git-multi-pack-index#_see_also)SEE ALSO
See [The Multi-Pack-Index Design Document](https://git-scm.com/docs/multi-pack-index) and [gitformat-pack[5]](https://git-scm.com/docs/gitformat-pack) for more information on the multi-pack-index feature and its file format.
