...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [OPTIONS](https://git-scm.com/docs/git-http-fetch#_options)
    * [GIT](https://git-scm.com/docs/git-http-fetch#_git)


[ English ▾](https://git-scm.com/docs/git-http-fetch)
Localized versions of **git-http-fetch** manual
  1. [English ](https://git-scm.com/docs/git-http-fetch)
  2. [Français ](https://git-scm.com/docs/git-http-fetch/fr)
  3. [Português (Brasil) ](https://git-scm.com/docs/git-http-fetch/pt_BR)
