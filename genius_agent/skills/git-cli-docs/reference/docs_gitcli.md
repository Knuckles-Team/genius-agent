...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [ENHANCED OPTION PARSER](https://git-scm.com/docs/gitcli#_enhanced_option_parser)
    * [NOTES ON FREQUENTLY CONFUSED OPTIONS](https://git-scm.com/docs/gitcli#_notes_on_frequently_confused_options)
    * [GIT](https://git-scm.com/docs/gitcli#_git)


[ English ▾](https://git-scm.com/docs/gitcli)
...
[ Latest version ▾ ](https://git-scm.com/docs/gitcli) gitcli last updated in 2.52.0
Changes in the **gitcli** manual
  1. 2.53.0 no changes
...
`git --version`
##  [](https://git-scm.com/docs/gitcli#_name)NAME
gitcli - Git command-line interface and conventions
##  [](https://git-scm.com/docs/gitcli#_synopsis)SYNOPSIS
gitcli
##  [](https://git-scm.com/docs/gitcli#_description)DESCRIPTION
...
The former lets your shell expand the fileglob, and you are asking the dot-C files in your working tree to be overwritten with the version in the index. The latter passes the `*.c` to Git, and you are asking the paths in the index that match the pattern to be checked out to your working tree. After running _git add hello.c; rm hello.c_ , you will _not_ see `hello.c` in your working tree with the former, but with the latter you will.
...
##  [](https://git-scm.com/docs/gitcli#_enhanced_option_parser)ENHANCED OPTION PARSER
...
###  [](https://git-scm.com/docs/gitcli#_options_trump_configuration_and_environment)Options trump configuration and environment
...
For example, the `user.name` configuration variable is used to specify the human-readable name used by the `git` `commit` command to record the author and the committer name in a newly created commit. The `GIT_AUTHOR_NAME` environment variable, if set, takes precedence when deciding what author name to record. The `--author=`_< author>_ command line option of the `git` `commit` command, when given, takes precedence over these two sources of information.
###  [](https://git-scm.com/docs/gitcli#_aggregating_short_options)Aggregating short options
...
###  [](https://git-scm.com/docs/gitcli#_abbreviating_long_options)Abbreviating long options
...
###  [](https://git-scm.com/docs/gitcli#_separating_argument_from_the_option)Separating argument from the option
...
###  [](https://git-scm.com/docs/gitcli#_magic_filename_options)Magic filename options
...
Like with configuration values, if the named file is missing Git behaves as if the option was not given at all. See "Values" in [git-config[1]](https://git-scm.com/docs/git-config).
##  [](https://git-scm.com/docs/gitcli#_notes_on_frequently_confused_options)NOTES ON FREQUENTLY CONFUSED OPTIONS
