...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [OPTIONS](https://git-scm.com/docs/git-cherry#_options)
    * [EXAMPLES](https://git-scm.com/docs/git-cherry#_examples)
    * [SEE ALSO](https://git-scm.com/docs/git-cherry#_see_also)
    * [GIT](https://git-scm.com/docs/git-cherry#_git)


[ English ▾](https://git-scm.com/docs/git-cherry)
Localized versions of **git-cherry** manual
  1. [English ](https://git-scm.com/docs/git-cherry)
  2. [Français ](https://git-scm.com/docs/git-cherry/fr)
  3. [Português (Brasil) ](https://git-scm.com/docs/git-cherry/pt_BR)
  4. [Русский ](https://git-scm.com/docs/git-cherry/ru)
...
[ Latest version ▾ ](https://git-scm.com/docs/git-cherry) git-cherry last updated in 2.0.5
...
`git --version`
##  [](https://git-scm.com/docs/git-cherry#_name)NAME
git-cherry - Find commits yet to be applied to upstream
##  [](https://git-scm.com/docs/git-cherry#_synopsis)SYNOPSIS
```
_git cherry_ [-v] [<upstream> [<head> [<limit>]]]
```

##  [](https://git-scm.com/docs/git-cherry#_description)DESCRIPTION
...
git-cherry is frequently used in patch-based workflows (see [gitworkflows[7]](https://git-scm.com/docs/gitworkflows)) to determine if a series of patches has been applied by the upstream maintainer. In such a workflow you might create and send a topic branch like this:
```
...
###  [](https://git-scm.com/docs/git-cherry#_concrete_example)Concrete example
...
###  [](https://git-scm.com/docs/git-cherry#_using_a_limit)Using a limit
...
##  [](https://git-scm.com/docs/git-cherry#_see_also)SEE ALSO
