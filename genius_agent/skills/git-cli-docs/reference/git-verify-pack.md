...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [OPTIONS](https://git-scm.com/docs/git-verify-pack#_options)
    * [OUTPUT FORMAT](https://git-scm.com/docs/git-verify-pack#_output_format)
    * [GIT](https://git-scm.com/docs/git-verify-pack#_git)


[ English ▾](https://git-scm.com/docs/git-verify-pack)
Localized versions of **git-verify-pack** manual
  1. [English ](https://git-scm.com/docs/git-verify-pack)
  2. [Português (Brasil) ](https://git-scm.com/docs/git-verify-pack/pt_BR)
  3. [Svenska ](https://git-scm.com/docs/git-verify-pack/sv)
