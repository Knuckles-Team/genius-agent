...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents 
    ...
    * [OPTIONS](https://git-scm.com/docs/git-for-each-repo#_options)
    * [SUBPROCESS BEHAVIOR](https://git-scm.com/docs/git-for-each-repo#_subprocess_behavior)
    * [GIT](https://git-scm.com/docs/git-for-each-repo#_git)


[ English ▾](https://git-scm.com/docs/git-for-each-repo)
...
[ Latest version ▾ ](https://git-scm.com/docs/git-for-each-repo) git-for-each-repo last updated in 2.45.3
Changes in the **git-for-each-repo** manual
  ...
  3. 2.30.1 → 2.45.2 no changes
  4. [2.30.0 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2020-12-27_ ](https://git-scm.com/docs/git-for-each-repo/2.30.0)


Check your version of git by running
`git --version`
##  [](https://git-scm.com/docs/git-for-each-repo#_name)NAME
git-for-each-repo - Run a Git command on a list of repositories
##  [](https://git-scm.com/docs/git-for-each-repo#_synopsis)SYNOPSIS
```
_git for-each-repo_ --config=<config> [--] <arguments>
```

##  [](https://git-scm.com/docs/git-for-each-repo#_description)DESCRIPTION
...
If any `git` `-C` _< repo>_ _< arguments>_ subprocess returns a non-zero exit code, then the `git` `for-each-repo` process returns that exit code without running more subprocesses.
Each `git` `-C` _< repo>_ _< arguments>_ subprocess inherits the standard file descriptors `stdin`, `stdout`, and `stderr`.
