...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [OPTIONS](https://git-scm.com/docs/git-check-attr#_options)
    * [OUTPUT](https://git-scm.com/docs/git-check-attr#_output)
    * [EXAMPLES](https://git-scm.com/docs/git-check-attr#_examples)
    * [SEE ALSO](https://git-scm.com/docs/git-check-attr#_see_also)
    * [GIT](https://git-scm.com/docs/git-check-attr#_git)


[ English ▾](https://git-scm.com/docs/git-check-attr)
Localized versions of **git-check-attr** manual
  1. [English ](https://git-scm.com/docs/git-check-attr)
  2. [Français ](https://git-scm.com/docs/git-check-attr/fr)
  3. [日本語 ](https://git-scm.com/docs/git-check-attr/ja)
  4. [Português (Brasil) ](https://git-scm.com/docs/git-check-attr/pt_BR)
  5. [Svenska ](https://git-scm.com/docs/git-check-attr/sv)
...
##  [](https://git-scm.com/docs/git-check-attr#_see_also)SEE ALSO
