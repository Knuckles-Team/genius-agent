...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [OPTIONS](https://git-scm.com/docs/git-fmt-merge-msg#_options)
    * [CONFIGURATION](https://git-scm.com/docs/git-fmt-merge-msg#_configuration)
    * [EXAMPLES](https://git-scm.com/docs/git-fmt-merge-msg#_examples)
    * [SEE ALSO](https://git-scm.com/docs/git-fmt-merge-msg#_see_also)
    * [GIT](https://git-scm.com/docs/git-fmt-merge-msg#_git)


[ English ▾](https://git-scm.com/docs/git-fmt-merge-msg)
Localized versions of **git-fmt-merge-msg** manual
  1. [English ](https://git-scm.com/docs/git-fmt-merge-msg)
  2. [Français ](https://git-scm.com/docs/git-fmt-merge-msg/fr)
  3. [Português (Brasil) ](https://git-scm.com/docs/git-fmt-merge-msg/pt_BR)
  4. [Svenska ](https://git-scm.com/docs/git-fmt-merge-msg/sv)
...
[ Latest version ▾ ](https://git-scm.com/docs/git-fmt-merge-msg) git-fmt-merge-msg last updated in 2.52.0
...
`git --version`
##  [](https://git-scm.com/docs/git-fmt-merge-msg#_name)NAME
git-fmt-merge-msg - Produce a merge commit message
##  [](https://git-scm.com/docs/git-fmt-merge-msg#_synopsis)SYNOPSIS
```
...
##  [](https://git-scm.com/docs/git-fmt-merge-msg#_see_also)SEE ALSO
