...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents
    ...
    * [OPTIONS](https://git-scm.com/docs/git-symbolic-ref#_options)
    * [NOTES](https://git-scm.com/docs/git-symbolic-ref#_notes)
    * [SEE ALSO](https://git-scm.com/docs/git-symbolic-ref#_see_also)
    * [GIT](https://git-scm.com/docs/git-symbolic-ref#_git)


[ English ▾](https://git-scm.com/docs/git-symbolic-ref)
Localized versions of **git-symbolic-ref** manual
  1. [English ](https://git-scm.com/docs/git-symbolic-ref)
  2. [Português (Brasil) ](https://git-scm.com/docs/git-symbolic-ref/pt_BR)
  3. [Svenska ](https://git-scm.com/docs/git-symbolic-ref/sv)
...
[ Latest version ▾ ](https://git-scm.com/docs/git-symbolic-ref) git-symbolic-ref last updated in 2.48.0
...
`git --version`
##  [](https://git-scm.com/docs/git-symbolic-ref#_name)NAME
git-symbolic-ref - Read, modify and delete symbolic refs
##  [](https://git-scm.com/docs/git-symbolic-ref#_synopsis)SYNOPSIS
```
_git symbolic-ref_ [-m <reason>] <name> <ref>
_git symbolic-ref_ [-q] [--short] [--no-recurse] <name>
_git symbolic-ref_ --delete [-q] <name>
```

##  [](https://git-scm.com/docs/git-symbolic-ref#_description)DESCRIPTION
...
##  [](https://git-scm.com/docs/git-symbolic-ref#_see_also)SEE ALSO
