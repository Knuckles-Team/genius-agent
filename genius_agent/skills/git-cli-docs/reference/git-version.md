...
![](https://git-scm.com/images/dark-mode.svg)
  ...
  * Table of Contents 
    ...
    * [OPTIONS](https://git-scm.com/docs/git-version#_options)
    * [GIT](https://git-scm.com/docs/git-version#_git)


[ English ▾](https://git-scm.com/docs/git-version)
...
[ Latest version ▾ ](https://git-scm.com/docs/git-version) git-version last updated in 2.50.0
Changes in the **git-version** manual
  ...
  3. 2.33.2 → 2.49.1 no changes
  4. [2.33.1 ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/green-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/red-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) ![](https://git-scm.com/images/icons/grey-dot.png) _2021-10-12_ ](https://git-scm.com/docs/git-version/2.33.1)


Check your version of git by running
`git --version`
##  [](https://git-scm.com/docs/git-version#_name)NAME
git-version - Display version information about Git
##  [](https://git-scm.com/docs/git-version#_synopsis)SYNOPSIS
```
_git version_ [--build-options]
```
