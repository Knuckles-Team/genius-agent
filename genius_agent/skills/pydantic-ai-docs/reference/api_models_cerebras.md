[ Skip to content ](https://ai.pydantic.dev/api/models/cerebras/#pydantic_aimodelscerebras)
...
[ pydantic/pydantic-ai
  ...
  * API Reference
    * pydantic_ai
      ...
      * pydantic_ai.models.cerebras  [ pydantic_ai.models.cerebras  ](https://ai.pydantic.dev/api/models/cerebras/)
        * [ Setup  ](https://ai.pydantic.dev/api/models/cerebras/#setup)
          * [ cerebras  ](https://ai.pydantic.dev/api/models/cerebras/#pydantic_ai.models.cerebras)
          * [ CerebrasModelName  ](https://ai.pydantic.dev/api/models/cerebras/#pydantic_ai.models.cerebras.CerebrasModelName)
          * [ CerebrasModelSettings  ](https://ai.pydantic.dev/api/models/cerebras/#pydantic_ai.models.cerebras.CerebrasModelSettings)
            * [ cerebras_disable_reasoning  ](https://ai.pydantic.dev/api/models/cerebras/#pydantic_ai.models.cerebras.CerebrasModelSettings.cerebras_disable_reasoning)
          * [ CerebrasModel  ](https://ai.pydantic.dev/api/models/cerebras/#pydantic_ai.models.cerebras.CerebrasModel)
            * [ __init__  ](https://ai.pydantic.dev/api/models/cerebras/#pydantic_ai.models.cerebras.CerebrasModel.__init__)
...
```
CerebrasModelName = str[](https://docs.python.org/3/library/stdtypes.html#str) | LatestCerebrasModelNames
...
```
cerebras_disable_reasoning: bool[](https://docs.python.org/3/library/functions.html#bool)
...
```
__init__(
    model_name: CerebrasModelName[](https://ai.pydantic.dev/api/models/cerebras/#pydantic_ai.models.cerebras.CerebrasModelName "CerebrasModelName



      module-attribute
   \(pydantic_ai.models.cerebras.CerebrasModelName\)"),
    *,
    provider: (
        Literal[](https://docs.python.org/3/library/typing.html#typing.Literal "typing.Literal")["cerebras"] | Provider[](https://ai.pydantic.dev/api/providers/#pydantic_ai.providers.Provider "pydantic_ai.providers.Provider")[AsyncOpenAI]
    ) = "cerebras",
    profile: ModelProfileSpec | None = None,
    settings: CerebrasModelSettings[](https://ai.pydantic.dev/api/models/cerebras/#pydantic_ai.models.cerebras.CerebrasModelSettings "CerebrasModelSettings \(pydantic_ai.models.cerebras.CerebrasModelSettings\)") | None = None
)
...
`model_name` |  `CerebrasModelName[](https://ai.pydantic.dev/api/models/cerebras/#pydantic_ai.models.cerebras.CerebrasModelName "CerebrasModelName
      ...
      module-attribute
   \(pydantic_ai.models.cerebras.CerebrasModelName\)")` |  The name of the Cerebras model to use. |  _required_
`provider` |  `Literal[](https://docs.python.org/3/library/typing.html#typing.Literal "typing.Literal")['cerebras'] | Provider[](https://ai.pydantic.dev/api/providers/#pydantic_ai.providers.Provider "pydantic_ai.providers.Provider")[AsyncOpenAI]` |  The provider to use. Defaults to 'cerebras'. |  `'cerebras'`
`profile` |  `ModelProfileSpec | None` |  The model profile to use. Defaults to a profile based on the model name. |  `None`
`settings` |  `CerebrasModelSettings[](https://ai.pydantic.dev/api/models/cerebras/#pydantic_ai.models.cerebras.CerebrasModelSettings "CerebrasModelSettings \(pydantic_ai.models.cerebras.CerebrasModelSettings\)") | None` |  Model-specific settings that will be used as defaults for this model. |  `None`
Source code in `pydantic_ai_slim/pydantic_ai/models/cerebras.py`
```
70
71
