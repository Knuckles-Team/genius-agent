[ Skip to content ](https://ai.pydantic.dev/models/huggingface/#hugging-face)
...
[ pydantic/pydantic-ai
  ...
  * Documentation
    ...
    * Models & Providers
      ...
      * Hugging Face  [ Hugging Face  ](https://ai.pydantic.dev/models/huggingface/)
        * [ Install  ](https://ai.pydantic.dev/models/huggingface/#install)
        * [ Configuration  ](https://ai.pydantic.dev/models/huggingface/#configuration)
        * [ Usage  ](https://ai.pydantic.dev/models/huggingface/#usage)
        * [ Configure the provider  ](https://ai.pydantic.dev/models/huggingface/#configure-the-provider)
        * [ Custom Hugging Face client  ](https://ai.pydantic.dev/models/huggingface/#custom-hugging-face-client)
...
[pip](https://ai.pydantic.dev/models/huggingface/#__tabbed_1_1)[uv](https://ai.pydantic.dev/models/huggingface/#__tabbed_1_2)
```
...
## Usage
You can then use [`HuggingFaceModel`](https://ai.pydantic.dev/api/models/huggingface/#pydantic_ai.models.huggingface.HuggingFaceModel "HuggingFaceModel
...
By default, the [`HuggingFaceModel`](https://ai.pydantic.dev/api/models/huggingface/#pydantic_ai.models.huggingface.HuggingFaceModel "HuggingFaceModel



      dataclass
  ") uses the [`HuggingFaceProvider`](https://ai.pydantic.dev/api/providers/#pydantic_ai.providers.huggingface.HuggingFaceProvider) that will select automatically the first of the inference providers (Cerebras, Together AI, Cohere..etc) available for the model, sorted by your preferred order in https://hf.co/settings/inference-providers.
