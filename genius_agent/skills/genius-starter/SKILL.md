...
name: genius-starter
description: >-
  Genius API + MCP Server + A2A Server Use when working with Genius via this package's MCP
...
license: MIT
tags: [genius-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Genius Starter Skill

Starter skill for the **Genius** package. Use the `mcp-client` universal skill
